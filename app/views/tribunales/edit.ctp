...
<div class="box">
    ...
    <div class="content form">
        <div class="row boton">
            <div class="boton">
                <?php echo $this->Html->link('Ingresar Deduccion por Tribunal', array('action' => 'add',$empleado['Empleado']['id'])); ?>
            </div>
            <div class="boton">
                <?php echo $this->Html->link('Regresar', array('controller'=>'tribunales','action' => 'index')); ?>
            </div>
        </div>
    </div>
</div>