<div class="box">
    ...
    <div class="content forms">
        <div class="row">
            ...
            <?php echo $this->Form->label('Nombre Cargo'); ?>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tbody>
                ...
                foreach ($historiales as $historia):
                    ...
                    <tr<?php echo $class; ?>>
                        <td></td>
                        <td><?php echo $historia['Historial']['FECHA_INI']; ?></td>                        
                        <td><?php echo $historia['Historial']['FECHA_FIN']; ?></td>                                                
...
<div class="box">
    <div class="title"><h2>Nuevo rango de Sueldo</h2>
        <?php echo $this->Html->image("title-hide.gif", array('class' => 'toggle')); ?>
    </div>
