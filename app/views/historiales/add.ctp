<script type="text/javascript">        
    function setVisibility() {
        if(document.getElementById('final').style.display != 'none'){
            ...
            document.getElementById('HistorialHISTORIALAÑOFIN').value="";
            document.getElementById('HistorialHISTORIALMESFIN').value="";
            document.getElementById('HistorialQUINCENAFIN').value="";
