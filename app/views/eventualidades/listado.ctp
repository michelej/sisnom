<div class="box">
    <div class="title"><h2><?php echo $eventualidad['Eventualidad']['NOMBRE']; ?></h2></div>
    <div class="content pages">        
        <div class="row">
            <?php
            echo $this->Form->create(false,array('url'=>array('controller'=>'eventualidades','action'=>'listado',$eventualidad['Eventualidad']['id'])));            
            echo "<div>";
        ...
        <table cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th style="width:47%; text-align: left">Cargo</th>
