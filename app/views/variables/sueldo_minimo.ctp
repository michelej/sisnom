<div class="box">
    <div class="title"><h2>Historial de Sueldo Minimo</h2>
        ...
        <table cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th style="width:45%"><?php echo $this->Paginator->sort('Sueldo Minimo', 'VALOR') ?></th>                                        
            ...
            <tbody>
                ...
                foreach ($variables as $variable):
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td class="actions">
                            <?php
                            echo $this->Html->image("file_delete.png", array("alt" => "Borrar", 'title' => 'Eliminar', 'width' => '18', 'heigth' => '18', 'url' => array('action' => 'delete_sueldo_minimo', $variable['Variable']['id'])));
                            ?>                            
                        </td>
                    </tr>
                <?php endforeach; ?>
...
<div class="box">
    ...
    <div class="content form">
        <div class="row boton">
            <div class="boton">
                <?php echo $this->Html->link('Nuevo Sueldo Minimo', array('action' => 'add_sueldo_minimo')); ?>
            </div>              
        </div>        
    </div>
</div>