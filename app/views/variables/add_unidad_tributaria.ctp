...
<div class="box">    
    ...
    <div class="content form">                
        <?php
        echo $this->Form->create('Variable',array('url' => array('controller' => 'variables', 'action' => 'add_unidad_tributaria')));
        echo $this->Form->input('NOMBRE', array('value' => 'Unidad Tributaria', 'type' => 'hidden'));        
...
<div class="box">
    ...
    <div class="content form">
        ...
        <div class="row boton">
            <div class="boton">
                <?php echo $this->Html->link('Regresar', array('action' => 'unidad_tributaria')); ?>
            </div>
        </div>
    </div>
</div>