...
<div class="box">
    <div class="title"><h2>Historial de Creditos Comerciales</h2>
        <?php echo $this->Html->image("title-hide.gif", array('class' => 'toggle')); ?>
    </div>
            ...
            <tbody>
                ...
                foreach ($comerciales as $comercial):
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td><?php echo $comercial['Comercial']['CANTIDAD']; ?></td>
                        <td></td>
                        <td class="actions">
                            <?php
...
<div class="box">
    ...
    <div class="content form">
        <div class="row boton">
            ...
            <div class="boton">
                <?php echo $this->Html->link('Regresar', array('controller'=>'comerciales','action' => 'index')); ?>
            </div>
        </div>
    </div>
</div>