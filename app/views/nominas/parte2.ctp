                        ...
                        foreach ($tabulador as $key => $tab) {
                            if (isset($tab['Empleado'])) {
                                ...
                                if (!is_array($tab['Empleado'])) {
                                    echo $this->Form->input('PRIMAS.' . $key . '.NOMBRE', array('value' => $tab['NOMBRE'], 'type' => 'hidden', 'label' => false, 'div' => false, 'class' => 'small'));
                                    echo '<td>' . $this->Form->input('PRIMAS.' . $key . '.Empleado', array('value' => $tab['Empleado'], 'label' => false, 'div' => false, 'class' => 'small')) . '</td>';
                                } else {
                                    echo '<td>  </td>';
                                    echo '</tr>';
                                    foreach ($tab['Empleado'] as $kb => $tb) {
                                        echo '<tr>';
                                        echo '<td>' . $kb . '</td>';
                                        echo '<td>' . $this->Form->input('PRIMAS.' . $key . '.Empleado.' . $kb, array('value' => $tb, 'label' => false, 'div' => false, 'class' => 'small')) . '</td>';
                                        echo '</tr>';
                                    }
                                }
                                echo '</tr>';
                        ...
                        foreach ($tabulador as $key => $tab) {
                            if (isset($tab['Obrero'])) {
                                ...
                                if (!is_array($tab['Obrero'])) {
                                    echo $this->Form->input('PRIMAS.' . $key . '.NOMBRE', array('value' => $tab['NOMBRE'], 'type' => 'hidden', 'label' => false, 'div' => false, 'class' => 'small'));
                                    echo '<td>' . $this->Form->input('PRIMAS.' . $key . '.Obrero', array('value' => $tab['Obrero'], 'label' => false, 'div' => false, 'class' => 'small')) . '</td>';
                                } else {
                                    echo '<td>  </td>';
                                    echo '</tr>';
                                    foreach ($tab['Obrero'] as $kb => $tb) {
                                        echo '<tr>';
                                        echo '<td>' . $kb . '</td>';
                                        echo '<td>' . $this->Form->input('PRIMAS.' . $key . '.Obrero.' . $kb, array('value' => $tb, 'label' => false, 'div' => false, 'class' => 'small')) . '</td>';
                                        echo '</tr>';
                                    }
                                }
                                echo '</tr>';
