<div class="box">
    <div class="title"><h2>Reporte Personal</h2></div>
            ...
            <tbody>
                ...
                foreach ($empleados as $empleado):
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td class="actions">
                            <?php
                            echo $this->Html->image("Printer.png", array("alt" => "Contratos", 'width' => '18', 'heigth' => '18', 'title' => 'Contratos del Empleado', 'url' => array('controller' => 'reportes', 'action' => 'reporte_persona', $empleado['Empleado']['id'])));                                                        
                            ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
