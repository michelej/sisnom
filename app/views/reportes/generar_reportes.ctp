<div class="box">
    <div class="title"><h2>Generación de Reportes</h2></div>
...
<div class="box">
    ...
    <div class="content pages">
        <div class="row">
            ...
            echo "<div class='row'>";
            echo "<div style='float:left;width:30%;'>";
            $options = array('1' => 'Reporte General','2'=>'Información de Contacto','3'=>'Direcciones','4'=>'Información Bancaria');
            echo $this->Form->input('TIPO_REPORTE', array('div' => false, 'label' => 'Tipo de Reporte', 'class' => 'small', 'type' => 'select', 'options' => $options));
            echo "</div>";
            echo "</div>";
