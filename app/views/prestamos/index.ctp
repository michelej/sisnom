            ...
            <tbody>
                ...
                foreach ($empleados as $empleado):
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td class="actions">
                            <?php
                            echo $this->Html->image("Money Bundle.png", array("alt" => "Prestamos", 'width' => '18', 'heigth' => '18', 'title' => 'Prestamos de Caja de Ahorro', 'url' => array('controller'=>'prestamos','action' => 'edit', $empleado['Empleado']['id'])));                            
                            ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
