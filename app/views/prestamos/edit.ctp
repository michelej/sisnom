            ...
            <tbody>
                ...
                foreach ($prestamos as $prestamo):
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td><?php echo $prestamo['Prestamo']['QUINCENA']; ?></td>                        
...
<div class="box">
    ...
    <div class="content form">
        <div class="row boton">
            <div class="boton">
                <?php echo $this->Html->link('Ingresar Prestamo de Caja de Ahorros', array('action' => 'add','empleadoId:'.$empleado['Empleado']['id'])); ?>
            </div>
            <div class="boton">
