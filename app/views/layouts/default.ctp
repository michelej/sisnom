                    ...
                    <ul> 
                        ...
                        <li>     
                            ...
                            <ul>                                                                 
                                ...
                                <li><?php echo $this->Html->link($this->Html->image("Finder.png", array('alt' => '', 'height' => '18', 'width' => '18')) . "Reporte Personal", array('controller' => 'reportes', 'action' => 'listado_persona'), array('escape' => false)); ?></li>
                            </ul> 
                        </li>
