...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es"> 
    ...
    <body> 
                    ...
                    <ul> 
                        ...
                        <li><a href="#"><?php echo $this->Html->image('file1.png', array("alt" => "Definiciones", 'width' => '18', 'heigth' => '18', 'title' => 'Definiciones')); ?>Definiciones</a>     
                            <ul>
                                ...
                                <li><?php echo $this->Html->link($this->Html->image("User.png", array('alt' => '', 'height' => '18', 'width' => '18')) . "   Cargos", array('controller' => 'cargos', 'action' => 'view'), array('escape' => false)); ?></li>  
                                <li><?php echo $this->Html->link($this->Html->image("Money.png", array('alt' => '', 'height' => '18', 'width' => '18')) . " Sueldos", array('controller' => 'sueldos', 'action' => 'view'), array('escape' => false)); ?></li>
        ...
        <?php //echo $this->Html->script('contratos.js');?>
    </body> 
</html> 