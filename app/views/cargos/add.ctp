<div class="box">
    ...
    <div class="content form">
        ...
        echo $this->Form->label('Nombre del Cargo');
        ...
        echo $this->Form->input('SUELDO', array('div' => false, 'label' => false, 'class' => 'medium'));
        echo "</div>";
        echo "</div>";
        echo "<div class='row'>";
        //echo $this->Form->input('CAR_UBICACION');
        //echo $this->Form->input('sueldos_id');
        echo "</div>";
        ?>
    </div>
</div>
