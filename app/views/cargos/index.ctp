    ...
    <div class="content pages">
        ...
        <table cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    <th></th>  
                    <th style="width:50%"><?php echo $this->Paginator->sort('Descripción', 'DESCRIPCION'); ?></th>                    
                    <th style="width:20%">><?php echo $this->Paginator->sort('Sueldo', 'SUELDO'); ?></th>
                    <th style="width:15%">><?php echo $this->Paginator->sort('Estado', 'ESTADO'); ?></th>			
                    <th style="width:15%" class="actions"><?php __('Actions'); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                foreach ($cargos as $cargo):
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td><?php echo $cargo['Cargo']['SUELDO']; ?></td>
