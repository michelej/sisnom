<div class="box">
    <div class="title"><h2><?php __('Administrar Empleado:: Modificar'); ?></h2>
    ...
    <div class="content tabs ui-tabs ui-widget ui-widget-content ui-corner-all">
        ...
        <div id="tab2" class="tabdiv ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide" style="">
            ...
            echo $this->Form->select('Asignacion.MODALIDAD', array($options), null, array('empty' => "Seleccione una opción"));
            echo "</div>";

            echo "<div style='float:left;width:30%'>";
            echo $this->Form->label('Departamento');
            echo $this->Form->input('Departamento.NOMBRE', array('div' => false, 'label' => false, 'class' => 'small'));            
            echo "</div>";

            echo "<div style='float:left;width:30%'>";
            echo $this->Form->label('Cargo');
            echo $this->Form->input('Cargo.NOMBRE', array('div' => false, 'label' => false, 'class' => 'small'));
            echo "</div>";
            echo "</div>";
            // END ROW
            ?>
